...
export const defaultCourses = [
  {
    ...
    overview: "A specialized program focused on medical laboratory technology, covering diagnostic testing, clinical pathology, and lab management.",
    eligibility: "10+2 (Science with PCB/PCM preferred)",
    careers: "Lab Technician, Diagnostic Expert, Quality Control Analyst",
    duration: "2 Years",
    icon: "Microscope",
    featured: true,
  },
  {
    ...
    overview: "Comprehensive training in physical therapy, rehabilitation techniques, and patient recovery management for various musculoskeletal conditions.",
    eligibility: "10+2 (Science with PCB preferred)",
    careers: "Physiotherapist Assistant, Rehabilitation Specialist, Sports Clinic Assistant",
    duration: "2 Years",
    icon: "Stethoscope",
    featured: true,
  },
  {
    ...
    overview: "Basic nursing program focusing on maternal healthcare, child health, and community health services in rural and urban settings.",
    eligibility: "10+2 (Any stream, Science preferred)",
    careers: "Auxiliary Nurse, Community Health Worker, Rural Health Worker",
    duration: "2 Years",
    icon: "Users",
    featured: true,
  },
  {
    ...
    overview: "Advanced nursing and midwifery program designed to prepare skilled nurses for hospital care, clinical settings, and patient management.",
    eligibility: "10+2 Science (PCB preferred). Min 45%, Age 17-35.",
    careers: "Staff Nurse, Clinical Care Professional, Ward In-charge",
    duration: "3.5 Years",
    icon: "Users",
    featured: true,
  },
  {
    ...
    overview: "Essential healthcare program enabling students to provide primary medical care and handle essential drugs in community settings.",
    eligibility: "10th or 12th Pass (Any stream)",
    careers: "Primary Healthcare Provider, Community Medical Assistant",
    duration: "18 Months",
    icon: "Syringe",
    featured: true,
  },
  {
    ...
    overview: "Specialized training in homeopathic medicine preparation, dispensing, and pharmacy management within the homeopathic healthcare system.",
    eligibility: "10+2 (Science preferred)",
    careers: "Homeopathic Pharmacist, Pharmacy Manager, Medical Store In-charge",
    duration: "2 Years",
    icon: "Microscope",
    featured: true,
  },
